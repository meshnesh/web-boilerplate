var svg = d3.select("#yellow").append("svg").append("g")
...
var color = d3.scale.ordinal().domain(["Lorem ipsum", "dolor sit", "amet", "consectetur", "adipisicing", "elit", "sed", "do", "eiusmod", "tempor", "incididunt"]).range(["#176739", "#1B7D45", "#25A75C", "#2ED073", "#58DA8F", "#2dcc70", "#81E3AA"]);
