...
(function (M, a) {
	...
	(function (a) {
		...
		F && !F.defaultView && (a.getStyle = function (m, f) {
			...
			m = m.currentStyle[f.replace(/\-(\w)/g, function (a, n) {
	...
	(function (a) {
		...
		D.prototype = {
			...
			, applyTextShadow: function (a) {
				...
				d ? this.css(c) : (this.fakeTS = !0, this.ySetter = this.xSetter, p = [].slice.call(C.getElementsByTagName("tspan")), w(a.split(/\s?,\s?/g), function (a) {
					var b = C.firstChild
						, E, e;
					a = a.split(" ");
					E = a[a.length - 1];
			...
			, align: function (a, b, p) {
				...
				var t, l;
				if (a) {
					if (this.alignOptions = a, this.alignByTranslate = b, !p || y(p)) this.alignTo = C = p || "renderer", c(e, this), e.push(this), p = null
				}
			...
			, shadow: function (a, b, p) {
				...
				if (!a) this.destroyShadows();
					...
					for (e = 1; e <= d; e++) E = A.cloneNode(0), c = 2 * d + 1 - 2 * e, m(E, {
						...
						, fill: "none"
					}), p && (m(E, "height", Math.max(m(E, "height") - c, 0)), E.cutHeight = c), b ? b.element.appendChild(E) : A.parentNode.insertBefore(E, A), C.push(E);
					this.shadows = C
				}
				return this
			}
		...
		z.prototype = {
			...
			, buildText: function (a) {
				for (var b = a.element, c = this, d = c.forExport, C = r(a.textStr, "").toString(), t = -1 !== C.indexOf("\x3c"), l = b.childNodes, y, u, x, k, n = m(b, "x"), H = a.styles, f = a.textWidth, K = H && H.lineHeight, h = H && H.textShadow, v = H && "ellipsis" === H.textOverflow, O = l.length, B = f && !a.added && this.box, P = function (a) {
						var b;
						b = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : H && H.fontSize || c.style.fontSize || 12;
						return K ? G(K) : c.fontMetrics(b, a).h
					}; O--;) b.removeChild(l[O]);
				t || h || v || f || -1 !== C.indexOf(" ") ? (y = /<.*class="([^"]+)".*>/, u = /<.*style="([^"]+)".*>/, x = /<.*href="(http[^"]+)".*>/, B && B.appendChild(b), C = t ? C.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [C], C = e(C, function (a) {
					return "" !== a
				}), w(C, function (e, E) {
					var C, t = 0;
			...
			, button: function (a, p, e, c, A, d, t, l, g) {
				...
				k = l.style;
				delete l.style;
				F(E.element, b ? "mouseover" : "mouseenter", function () {
					3 !== C && E.setState(1)
				});
			...
			, label: function (a, b, p, e, c, A, d, t, l) {
				...
				R = function () {
					...
					if (a !== g.x || b !== g.y) g.attr("x", a), void 0 !== b && g.attr("y", b);
					g.x = a;
					g.y = b
				};
				Q = function (a, b) {
	...
	(function (a) {
		...
		a.svg || (z = {
			...
			, dashstyleSetter: function (a, e, c) {
				(c.getElementsByTagName("stroke")[0] || F(this.renderer.prepVML(["\x3cstroke/\x3e"]), null, null, c))[e] = a || "solid";
				this[e] = a
			}
...
'" opacity\x3d"', E, '" o:opacity2\x3d"', C, '" type\x3d"', t, '" ', v, 'focus\x3d"100%" method\x3d"any" /\x3e'];
					...
					if ("fill" === c)
						if ("gradient" === t) c = f.x1 || f[0] || 0, b = f.y1 || f[1] || 0, h = f.x2 || f[2] || 0, f = f.y2 || f[3] || 0, v = 'angle\x3d"' + (90 - 180 * Math.atan((f - b) / (h - c)) / Math.PI) + '"', q();
						else {
							var k = f.r
								, L = 2 * k
								, m = 2 * k
	...
	(function (a) {
		...
		a.defaultOptions = {
			...
			, credits: {
				enabled: !0
				, href: "http://www.DataScience.co.ke"
				, position: {
					align: "right"
					, x: -10
					, verticalAlign: "bottom"
	...
	(function (a) {
		...
		a.AxisPlotLineOrBandExtension = {
			getPlotBandPath: function (a, k) {
				...
				(a = this.getPlotLinePath(a, null, null, !0)) && k ? (a.flat = a.toString() === k.toString(), a.push(k[4], k[5], k[1], k[2])) : a = null;
				return a
			}
...
[], h.plotBands || [], d.plotBands || []], function (d) {
	...
	(function (a) {
		...
		a.Axis.prototype = {
			...
			, getMinorTickPositions: function () {
				...
				if (g && g / e < this.len / 3)
					if (this.isLog)
						for (l = b.length, d = 1; d < l; d++) c = c.concat(this.getLogTickPositions(e, b[d - 1], b[d], !0));
			...
			, adjustForMinRange: function () {
				var a = this.options
					...
					, g, r, u, f, k, h;
				this.isXAxis && void 0 === this.minRange && !this.isLog && (n(a.min) || n(a.max) ? this.minRange = null : (d(this.series, function (a) {
					f = a.xData;
			...
			, getOffset: function () {
				...
				if (h || a.isLinked) d(l, function (b) {
					...
					1: "left"
					, 3: "right"
				}[u] !== a.labelAlign && "center" !== a.labelAlign || d(l, function (a) {
			...
			, render: function () {
				...
				}), a._addedPlotLB || (d((l.plotLines || []).concat(l.plotBands || []), function (b) {
	...
	(function (a) {
		...
		D.prototype.getTimeTicks = function (a, k, q, c) {
			...
			if (m(k)) {
				...
				c = 1;
				if (z.hcTimezoneOffset || z.hcGetTimezoneOffset) B = (!g || !!z.hcGetTimezoneOffset) && (q - k > 4 * d.month || n(k) !== n(q)), b = b.getTime(), b = new z(b + n(b));
				w = b[z.hcGetFullYear]();
				k = b.getTime();
				g = b[z.hcGetMonth]();
	...
	(function (a) {
		...
		D.prototype.getLogTickPositions = function (a, h, q, n) {
			...
			else h = d(h), q = d(q), a = f[n ? "minorTickInterval" : "tickInterval"], a = m("auto" === a ? null : a, this._minorAutoInterval, f.tickPixelInterval / (n ? 5 : 1) * (q - h) / ((n ? v / this.tickPositions.length : v) || 1)), a = J(a, null, z(a)), w = F(this.getLinearTickPositions(a, h, q), g), n || (this._minorAutoInterval = a / 5);
	...
	(function (a) {
		...
		D.prototype = {
			...
			, handleOverflow: function (a) {
				...
				k && (b = Math.min(b, k));
				H.length = 0;
				a > b && !1 !== x.enabled ? (this.clipHeight = n = Math.max(b - 20 - this.titleHeight - q, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, f(A, function (a, b) {
					...
					c.scroll(-1, w)
				}).add(G), this.pager = g.text("", 15, 10).addClass("highcharts-legend-navigation").css(x.style).add(G), this.down = g.symbol("triangle-down", 0, 0, r, r).on("click", function () {
					c.scroll(1, w)
	...
	(function (a) {
		...
		C.prototype = {
			...
			, addCredits: function (a) {
				...
				a.enabled && !this.credits && (this.credits = this.renderer.text(a.text + (this.mapCredits || ""), 0, 0).on("click", function () {
		...
		D.prototype = {
			...
			, optionsToObject: function (a) {
				...
				if (q(a) || null === a) d[k[0]] = a;
					...
					for (!f && a.length > c && (g = typeof a[0], "string" === g ? d.name = a[0] : "number" === g && (d.x = a[0]), e++); l < c;) f && void 0 === a[e] || (d[k[l]] = a[e]), e++, l++;
		...
		a.Series = a.seriesType("line", null, {
			...
			, bindAxes: function () {
				...
				k(a.axisTypes || [], function (g) {
					k(c[g], function (c) {
						e = c.options;
						if (b[g] === e.index || void 0 !== b[g] && b[g] === e.id || void 0 === b[g] && 0 === e.index) c.series.push(a), a[g] = c, c.isDirty = !0
					});
				...
				if (!1 !== f && t && n === t && !h.cropped && !h.hasGroupedData && h.visible) k(a, function (a, b) {
					...
					if (G && t > G) {
						...
						if (e(m))
							...
							if (v)
								for (g = 0; g < t; g++) m = a[g], q[g] = m[0], w[g] = m.slice(1, v + 1);
							else
			...
			, processData: function (a) {
				...
				if (t && this.sorted && !n && (!k || e > k || this.forceCrop))
					...
					else if (b[0] < m || b[e - 1] > x) g = this.cropData(this.xData, this.yData, m, x), b = g.xData, c = g.yData, g = g.start, f = !0;
			...
			, destroy: function () {
				...
				k(a.axisTypes || [], function (b) {
					(l = a[b]) && l.series && (v(l.series, a), l.isDirty = l.forceRedraw = !0)
				});
			...
			, applyZones: function () {
				var a = this
					...
					, u, x, y = b.inverted
					, q, w, v, K, I = !1;
				d.length && (l || n) && m && void 0 !== m.min && (x = m.reversed, q = m.horiz, l && l.hide(), n && n.hide(), u = m.getExtremes(), k(d, function (d, k) {
	...
	(function (a) {
		...
		z.prototype.buildStacks = function () {
			...
			if (!this.isXAxis) {
				...
				for (h = g; h--;) f = a[d ? h : g - h - 1], f.setStackCliffs && f.setStackCliffs();
		...
		z.prototype.resetStacks = function () {
			...
			if (!this.isXAxis)
				for (f in a)
					for (d in a[f]) a[f][d].touched < this.stacksTouched ? (a[f][d].destroy(), delete a[f][d]) : (a[f][d].total = null, a[f][d].cum = 0)
		};
		...
		a.prototype.setPercentStacks = function () {
			...
			h([f, "-" + f], function (f) {
				for (var c = g.length, e, h; c--;)
					if (e = g[c], n = a.getStackIndicator(n, e, a.index, f), e = (h = d[f] && d[f][e]) && h.points[n.key]) h = h.total ? 100 / h.total : 0, e[0] = J(e[0] * h), e[1] = J(e[1] * h), a.stackedYData[c] = e[1]
			})
		};
	...
	(function (a) {
		...
		k("pie", "line", {
			...
			, updateTotals: function () {
				...
				for (a = 0; a < k; a++) c = h[a], 0 > c.y && (c.y = null), f += e && !c.visible ? 0 : c.y;
				this.total = f;
			...
			, setVisible: function (a, f) {
				...
				f = h(f, e);
				a !== d.visible && (d.visible = d.options.visible = a = void 0 === a ? !d.visible : a, g.options.data[m(d, g.data)] = d.options, F(["graphic", "dataLabel", "connector", "shadowGroup"], function (c) {
...
, a[5]] : ["M", c + ("left" === a[6] ? 5 : -5), d, "L", a[2], a[3], "L", a[4], a[5]]
	...
	(function (a) {
		...
		D.prototype.hideOverlappingLabels = function (a) {
			...
			for (m = 0; m < f; m++)
				if (h = a[m]) h.oldOpacity = h.opacity, h.newOpacity = 1;
			a.sort(function (a, c) {
		...
		L = a.TrackerMixin = {
			drawTrackerPoint: function () {
				var a = this
					...
					, d = c.pointer
					, e = function (a) {
						for (var b = a.target, d; b && !d;) d = b.point, b = b.parentNode;
		...
		q(z.prototype, {
			...
			, zoom: function (a) {
				...
				!a || a.resetSelection ? h(this.axes, function (a) {
					...
					var d = a.axis
						, f = d.isXAxis;
					if (c[f ? "zoomX" : "zoomY"] || c[f ? "pinchX" : "pinchY"]) b = d.zoom(a.min, a.max), d.displayBtn && (e = !0)
				});
		...
		q(c.prototype, {
			...
			, setState: function (b, c) {
				...
				if (!(b === this.state && !c || this.selected && "select" !== b || !1 === h.enabled || b && (n || l && !1 === m.enabled) || b && t.states && t.states[b] && !1 === t.states[b].enabled)) {
					...
					if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), b && this.graphic.addClass("highcharts-point-" + b), this.graphic.attr(g.pointAttribs(this, b)), w && this.graphic.animate(w, B(u.options.chart.animation, m.animation, k.animation)), p && p.hide();
					else {
						if (b && m) {
							k = t.symbol || g.symbol;
